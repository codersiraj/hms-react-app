...
const appointments = [
  { id: "P001", time: "09:00 AM", name: "Arun Kumar", doctor: "Dr. Meena", status: "Waiting" },
  { id: "P002", time: "10:00 AM", name: "Sara Devi", doctor: "Dr. Anil", status: "Consulted" },
  { id: "P003", time: "11:30 AM", name: "Ravi Teja", doctor: "Dr. Bala", status: "In Consultation" },
];
        ...
        <table className="w-full text-sm text-left min-w-[500px]">
          ...
          <tbody>
            {appointments.map((appt) => (
              <tr key={appt.id} className="border-b text-[#1d4e89]">
                <td className="py-2">{appt.time}</td>
                <td
                  className="py-2 text-cyan-700 font-medium cursor-pointer hover:underline"
                  onClick={() => navigate(`/patient/${appt.id}`)}
                >
                  {appt.name}
                </td>
